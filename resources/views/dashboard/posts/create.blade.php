                    ...
                    <form action="{{ route('dashboard.posts.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea id="excerpt" name="excerpt" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('excerpt') }}</textarea>
                            ...
                            <div>
                                ...
                                <x-text-input id="featured_image" class="block mt-1 w-full" type="url" name="featured_image" :value="old('featured_image')" />
                            ...
                            <div>
                                ...
                                <textarea id="meta_description" name="meta_description" rows="2" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('meta_description') }}</textarea>
