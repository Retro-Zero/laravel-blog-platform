            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div class="text-center">
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">
                        Edit <span class="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Post</span>
                    </h1>
                    <p class="text-xl text-gray-600">Update your post content and settings</p>
                </div>
            </div>
        </div>
                    ...
                    <form action="{{ route('dashboard.posts.update', $post) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-8">
                            ...
                            <div>
                                ...
                                <x-text-input id="title" class="block w-full text-lg" type="text" name="title" :value="old('title', $post->title)" required autofocus placeholder="Enter your post title..." />
                            ...
                            <div>
                                ...
                                <textarea id="excerpt" name="excerpt" rows="3" class="block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-xl shadow-sm text-base" placeholder="Write a brief summary of your post...">{{ old('excerpt', $post->excerpt) }}</textarea>
                            ...
                            <div>
                                ...
                                <div id="url-input" class="mb-4">
                                    <x-text-input id="featured_image" class="block w-full text-base" type="url" name="featured_image" :value="old('featured_image', $post->featured_image)" placeholder="https://example.com/image.jpg" />
                            ...
                            <div class="bg-gray-50 rounded-xl p-6">
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="meta_title" class="block w-full text-base" type="text" name="meta_title" :value="old('meta_title', $post->meta_title)" placeholder="SEO-optimized title for search engines..." />
                                    ...
                                    <div>
                                        ...
                                        <textarea id="meta_description" name="meta_description" rows="2" class="block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-xl shadow-sm text-base" placeholder="Brief description for search engine results...">{{ old('meta_description', $post->meta_description) }}</textarea>
