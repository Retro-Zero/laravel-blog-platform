        ...
        <div class="flex items-center justify-center min-h-screen relative z-10">
            <div class="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-md p-10 border border-white/20 animate-fade-in-up">
                <div class="flex flex-col items-center mb-8">
                    ...
                    <h2 class="text-3xl font-bold text-white mb-1">Join BlogVerse</h2>
                    <p class="text-white/60 mb-2 text-base">Create your account</p>
                </div>
                ...
                <div class="text-center mt-8 text-base text-white/60">
                    Already have an account? <a href="{{ route('login') }}" class="text-purple-300 font-bold hover:text-purple-200 transition-colors">Sign In</a>
                </div>
            </div>
        </div>
