        ...
        <div class="flex items-center justify-center min-h-screen relative z-10">
            <div class="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-md p-10 border border-white/20 animate-fade-in-up">
                <div class="flex flex-col items-center mb-8">
                    ...
                    <h2 class="text-3xl font-bold text-white mb-1">Reset Password</h2>
                    <p class="text-white/60 mb-2 text-base">Enter your new password</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-7">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" required autofocus autocomplete="username" value="{{ old('email', $request->email) }}" 
